            ...
            <div class="model_content">
                <div class="model_content_inner" :style="{height: $store.state.home.modelContentHeight - 20 + 'px', overflow: 'auto'}">
                    <div class="header_seach_wrap" style="padding: 15px">
                        <el-select filterable v-model="tableMember.mallId" size="small" placeholder="购买商品统计">
                    ...
                    <div class='bottom-card'>
                        <p>
                            ...
                            <span>商品种数<span style="font-weight:800;color:#F56C6C">{{number}}</span></span>
                        </p>
                        <p>
                            ...
                            <span>商品数量<span style="font-weight:800;color:#F56C6C">{{number}}</span></span>
                        </p>
                    </div>
                </div>
            </div>
