            ...
            <div class="model_content">
                <div class="model_content_inner" :style="{height: $store.state.home.modelContentHeight - 20 + 'px', overflow: 'auto'}">
                    <div class="header_seach_wrap" style="padding: 15px">
                        <el-select filterable v-model="tableMember.mallId" size="small" placeholder="历史消费单据">
                            <el-option v-for="item in mallList" :key="item.id" :label="item.mallName" :value="item.id">
                            </el-option>
                        </el-select>
                        <el-select filterable v-model="tableMember.mallId" size="small" placeholder="全部单据">
                            <el-option v-for="item in mallList" :key="item.id" :label="item.mallName" :value="item.id">
                            </el-option>
                        </el-select>
                        <el-date-picker
                    ...
                    <el-table
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <div>
                                    <p v-if='scope.row.purchaseOrderNo'>{{scope.row.purchaseOrderNo | time_s}}</p>
                                    <p v-else>-</p>
                                </div>
                            </template>
                        </el-table-column>
                    ...
                    <div class='bottom-card'>
                        <p>
                            ...
                            <span>消费金额<span style="font-weight:800;color:#F56C6C">{{number}}</span></span>
                        </p>
                        <p>
                            ...
                            <span>消费单数<span style="font-weight:800;color:#F56C6C">{{number}}</span></span>
                        </p>
                    </div>
                </div>
            </div>
