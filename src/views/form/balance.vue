        ...
        <div class="model_content">
            <div class="model_content_inner" :style="{height: $store.state.home.modelContentHeight - 20 + 'px', overflow: 'auto'}">
                ...
                <el-table :data="tableData" ref="purchaseListTable" @selection-change="handleSelectionChange" style="width: 100%" show-summary :summary-method="getSummaries" class="formTotal">
                    ...
                    <el-table-column prop="purchaseOrderNo" label="开卡店铺">
                    </el-table-column>
                    ...
                    <el-table-column prop="purchaseOrderNo" label="会员等级">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo" label="积分">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo1" label="储值余额">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo1" label="次卡余额">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo" label="到期">
                    </el-table-column>
                </el-table>
            </div>
        </div>
