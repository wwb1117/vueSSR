        ...
        <div class="model_content">
            <div class="model_content_inner" :style="{height: $store.state.home.modelContentHeight - 20 + 'px', overflow: 'auto'}">
                ...
                <el-table :data="tableData" ref="purchaseListTable" @selection-change="handleSelectionChange" style="width: 100%" show-summary :summary-method="getSummaries" class="formTotal">
                    ...
                    <el-table-column prop="purchaseOrderNo" label="销售数量">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo1" label="销售金额">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo1" label="销售成本">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo1" label="销售利润">
                    </el-table-column>
                    <el-table-column prop="purchaseOrderNo" label="销售利润率(%)" min-width="140">
                    </el-table-column>
                </el-table>
            </div>
        </div>
        <el-dialog title="销售分布" :visible.sync="numDialogVisible">
            <span style="position:relative;top:-15px;font-weight:bold;">小西乐尿不湿\8591200335</span>
            <el-table :data="tableData" style="width: 100%;border: 1px solid #ebeef5;border-bottom:none;">
                <el-table-column label="店铺" prop="purchaseOrderNo" min-width="180"></el-table-column>
                <el-table-column label="销售" prop="purchaseOrderNo1" width="100"></el-table-column>
                <el-table-column label="销售额" prop="purchaseOrderNo1" width="100"></el-table-column>
                <el-table-column label="成本" prop="purchaseOrderNo1" width="100"></el-table-column>
                <el-table-column label="利润" prop="purchaseOrderNo1" width="100"></el-table-column>
                <el-table-column label="利润率" prop="purchaseOrderNo1" width="100"></el-table-column>
            </el-table>
            <span slot="footer" class="dialog-footer">
                <el-button @click="numDialogVisible = false">关 闭</el-button>
            </span>
        </el-dialog>
